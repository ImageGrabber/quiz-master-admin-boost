...
const EnglishSongDetail = () => {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col">
                ...
                <main className="flex-grow container mx-auto px-4 py-8 flex flex-col items-center justify-center">
                    ...
                    <Button onClick={() => navigate("/english-songs")}>Back to English Songs</Button>
                </main>
                <Footer />
            </div>
        );
    ...
    const currentTranslation = song.translations[selectedLang] || song.translations['english'];
    ...
    const jsonLd = {
        ...
        "@graph": [
            ...
            ...(song.videoUrl ? [generateVideoSchema({
                title: `${song.title} - English Christian Hymn Lyrics & Video`,
                description: `Read lyrics and watch video for the classic Christian hymn "${song.title}".`,
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <Helmet>
                <title>{song.title} | English Christian Hymn Lyrics | Bible Quiz Competition</title>
                <meta name="description" content={`Read lyrics for the classic hymn "${song.title}". ${song.description}`} />
                <meta name="keywords" content={`Christian hymns, ${song.title} lyrics, worship songs, English hymns, Bible Quiz Competition`} />
                <link rel="canonical" href={`https://biblequizcompetition.com/english-songs/${song.slug}`} />
                <meta property="og:type" content="music.song" />
                <meta property="og:url" content={`https://biblequizcompetition.com/english-songs/${song.slug}`} />
                <meta property="og:title" content={`${song.title} - Hymn Lyrics`} />
            ...
            <main className="flex-grow w-full py-8 px-4 md:px-8 lg:px-12">
                <div className="flex justify-between items-center max-w-7xl mx-auto mb-6">
                    <Button variant="ghost" className="pl-0 hover:bg-transparent hover:text-indigo-600" onClick={() => navigate("/english-songs")}>
                        <ArrowLeft className="mr-2 h-4 w-4" /> Back to English Songs
                    </Button>
                ...
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start h-full max-w-7xl mx-auto">
                    ...
                    <div className="space-y-4 md:sticky md:top-24">
                        {song.videoUrl ? (
                            ...
                            <div className="bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl h-64 flex items-center justify-center">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-10 animate-fade-in-up delay-100">
                        <h2 className="text-xl font-semibold text-indigo-600/80 mb-6 flex items-center justify-center gap-2">
                            Hymn Lyrics
                        </h2>
...
export default EnglishSongDetail;
