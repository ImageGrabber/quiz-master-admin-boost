    ...
    <div className="min-h-screen bg-white text-gray-900 font-urbanist selection:bg-black/5">
      ...
      <div className="w-full max-w-7xl mx-auto px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-10 text-left">
              <div className="space-y-6">
                ...
                <h3 className="text-5xl md:text-6xl font-normal leading-tight text-gray-900 italic serif">From Priest to Prophet to King</h3>
              </div>
        ...
        <section id="difficulty" className="mb-40 scroll-mt-24 text-center">
          <div className="mb-20">
            <h2 className="text-5xl md:text-6xl font-normal text-gray-900 mb-6 italic serif uppercase leading-tight font-serif tracking-tighter italic">Choose Your Path</h2>
