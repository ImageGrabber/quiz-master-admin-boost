...
const questions = [
  { chapter: 15, question: "What did Abram say about his heir?", options: ["Eliezer of Damascus", "Lot his nephew", "His servant", "His brother"], answer: 0 },
  { chapter: 15, question: "What did God promise Abram?", options: ["A son from his own body", "A great reward", "A kingdom", "A temple"], answer: 0 },
...
export default function GenesisCh15Advanced() {
  return <BibleBookQuiz title="Genesis 15 - Advanced" questions={questions} bookName="Genesis" />;
}
