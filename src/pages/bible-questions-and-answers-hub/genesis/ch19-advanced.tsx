...
const questions = [
  ...
  { chapter: 19, question: "Where was Lot sitting when they came?", options: ["In his house", "At the gate of Sodom", "In the field", "By the well"], answer: 1 },
  { chapter: 19, question: "What did Lot do when he saw them?", options: ["Ran away", "Bowed down with his face to the ground", "Called his family", "Warned them"], answer: 1 },
...
export default function GenesisCh19Advanced() {
  return <BibleBookQuiz title="Genesis 19 - Advanced" questions={questions} bookName="Genesis" />;
}
