...
export const bibleData: Record<string, Record<number, BibleChapter>> = {
  ...
  leviticus: {
    1: { title: "Leviticus Chapter 1", subtitle: "The Burnt Offering", description: "Instructions for voluntary offerings of livestock, birds, and grain as a pleasing aroma to the Lord.", keyPoints: ["Voluntary burnt offering", "Unblemished male livestock", "Pleasing aroma to the Lord"] },
    2: { title: "Leviticus Chapter 2", subtitle: "The Grain Offering", description: "Regulations for offerings of fine flour, oil, and incense, emphasizing the absence of leaven and the presence of salt.", keyPoints: ["Fine flour and oil", "No leaven or honey", "Salt of the covenant"] },
    3: { title: "Leviticus Chapter 3", subtitle: "The Peace Offering", description: "Laws concerning fellowship offerings from the herd or flock, symbolizing communal peace with God.", keyPoints: ["Fellowship offering", "Fat belongs to the Lord", "Shared meal with God"] },
    4: { title: "Leviticus Chapter 4", subtitle: "The Sin Offering", description: "Procedures for atonement when a person sins unintentionally against any of the Lord's commandments.", keyPoints: ["Unintentional sin", "Atonement based on status", "Sprinkling of blood"] },
    5: { title: "Leviticus Chapter 5", subtitle: "The Guilt Offering", description: "Restitution and atonement for specific sins like touching uncleanness or breaking oaths.", keyPoints: ["Restitution for trespass", "Confession of sin", "Specific guilt offerings"] },
    6: { title: "Leviticus Chapter 6", subtitle: "Priestly Duties", description: "Detailed commands for the priests regarding building and maintaining the fire on the altar.", keyPoints: ["The fire must never go out", "Priests' portion of grain", "Offerings of ordination"] },
    7: { title: "Leviticus Chapter 7", subtitle: "Priests' Share", description: "Regulations on the distribution of sacrifices and the prohibition of eating fat or blood.", keyPoints: ["No fat or blood", "Wave offering and heave offering", "Purity in eating the sacrifice"] },
    8: { title: "Leviticus Chapter 8", subtitle: "Ordination of Aaron", description: "The public ceremony as Moses consecrates Aaron and his sons for the priesthood.", keyPoints: ["Consecration with oil and blood", "Seven days in the Tabernacle", "Washed, clothed, and anointed"] },
    9: { title: "Leviticus Chapter 9", subtitle: "The Priests Begin", description: "Aaron begins his ministry, and the glory of the Lord appears to all the people.", keyPoints: ["First sacrifices and blessings", "Fire from the Lord", "Glory of God revealed"] },
    10: { title: "Leviticus Chapter 10", subtitle: "Nadab & Abihu", description: "The judgment on Aaron's sons for offering unauthorized fire, and laws for the priesthood.", keyPoints: ["Strange fire and death", "Prohibition of alcohol for priests", "Holy vs Common"] },
    11: { title: "Leviticus Chapter 11", subtitle: "Clean & Unclean", description: "Laws distinguishing between clean and unclean animals, fish, and birds for food.", keyPoints: ["Dietary laws", "Land animals, sea, and air", "Sanctification through diet"] },
    12: { title: "Leviticus Chapter 12", subtitle: "Childbirth Laws", description: "Purification rituals for women after childbirth and the sign of circumcision.", keyPoints: ["Purification time", "Male and female births", "Sacrifices for cleansing"] },
    13: { title: "Leviticus Chapter 13", subtitle: "Skin Diseases", description: "Regulations for the priest to identify and isolate infectious skin diseases and defiling mold.", keyPoints: ["Leprosy and skin exam", "Isolation and quarantine", "Contaminated clothing"] },
    14: { title: "Leviticus Chapter 14", subtitle: "Cleansing Lepers", description: "Complex rituals for the restoration of a healed leper back into the community.", keyPoints: ["The two birds ritual", "Shaving and bathing", "Cleansing of infected houses"] },
    15: { title: "Leviticus Chapter 15", subtitle: "Bodily Discharges", description: "Laws concerning ceremonial uncleanness resulting from bodily discharges in men and women.", keyPoints: ["Personal purity", "Washing and bathing", "Separation from uncleanness"] },
    16: { title: "Leviticus Chapter 16", subtitle: "Day of Atonement", description: "The high priest enters the Most Holy Place once a year to make atonement for all Israel.", keyPoints: ["Yom Kippur", "The Scapegoat", "Atonement for the Sanctuary"] },
    17: { title: "Leviticus Chapter 17", subtitle: "The Altar & Blood", description: "The requirement to sacrifice only at the Tabernacle and the absolute prohibition of eating blood.", keyPoints: ["Life is in the blood", "No hunting sacrifices", "Centralized worship"] },
    18: { title: "Leviticus Chapter 18", subtitle: "Sexual Purity", description: "Laws defining moral holiness and prohibiting the abominable practices of surrounding nations.", keyPoints: ["Forbidden relationships", "Purity of the land", "Moral separation"] },
    19: { title: "Leviticus Chapter 19", subtitle: "Laws of Holiness", description: "A wide-ranging collection of laws emphasizing social justice and personal ethics: 'Be holy, for I am holy.'", keyPoints: ["Love your neighbor", "Justice for the poor", "Sabbath and idols"] },
    20: { title: "Leviticus Chapter 20", subtitle: "Punishments", description: "The penalties for severe violations of holiness, emphasizing the sanctity of the community.", keyPoints: ["Death penalty for Molek worship", "Penalties for immorality", "Sanctification call"] },
    21: { title: "Leviticus Chapter 21", subtitle: "Rules for Priests", description: "High standards of personal holiness and eligibility for the priests and the high priest.", keyPoints: ["Priestly mourning laws", "No physical blemishes", "Holy marital standards"] },
    22: { title: "Leviticus Chapter 22", subtitle: "Sacred Offerings", description: "Purity requirements for those who eat the holy offerings and the quality of sacrifices.", keyPoints: ["Purity to handle holy things", "Acceptable sacrifices", "Profaning God's name"] },
    23: { title: "Leviticus Chapter 23", subtitle: "Appointed Feasts", description: "A calendar of the Lord's feasts: Sabbath, Passover, Firstfruits, Weeks, Trumpets, Atonement, and Tabernacles.", keyPoints: ["The sacred calendar", "National assemblies", "Remembrance and worship"] },
    24: { title: "Leviticus Chapter 24", subtitle: "Lamp & Bread", description: "The continual lighting of the lamp, the showbread, and the law of retribution.", keyPoints: ["The Golden Lampstand", "Bread of the Presence", "An eye for an eye"] },
    25: { title: "Leviticus Chapter 25", subtitle: "Sabbath Year & Jubilee", description: "Laws for the land's rest every seven years and the total liberation of the year of Jubilee.", keyPoints: ["The land's Sabbath", "Redemption of properties", "Release of slaves"] },
    26: { title: "Leviticus Chapter 26", subtitle: "Blessings & Curses", description: "The promises of prosperity for obedience and the warnings of judgment for persistent rebellion.", keyPoints: ["Rain and peace", "The five-fold curses", "I will remember the covenant"] },
    27: { title: "Leviticus Chapter 27", subtitle: "Vows & Tithes", description: "Valuations for vows of persons, animals, and houses, and the final rules for tithes.", keyPoints: ["Redemption of vows", "The Lord's portion", "Tithes from land and herd"] }
  },
  numbers: {
    1: { title: "Numbers Chapter 1", subtitle: "The First Census", description: "God commands a census of all men in Israel twenty years old and upward who are able to serve in the army.", keyPoints: ["Census at Sinai", "603,550 men counted", "Levites excluded for Tabernacle service"] },
    2: { title: "Numbers Chapter 2", subtitle: "The Camp Arrangement", description: "The specific layout of the tribal camps around the Tabernacle during their wilderness journey.", keyPoints: ["Standard of Judah to the East", "Tabernacle in the center", "Order of marching"] },
    3: { title: "Numbers Chapter 3", subtitle: "Duties of Levites", description: "The appointment of the Levites as a substitute for the firstborn of Israel and their specific temple duties.", keyPoints: ["Death of Nadab and Abihu", "Census of Levites", "Redemption of the firstborn"] },
    4: { title: "Numbers Chapter 4", subtitle: "Kohathite Duties", description: "Instructions for the transport of the Tabernacle's most holy things by the Kohathite clan.", keyPoints: ["Holy articles preparation", "Age of service 30-50", "Care of the Ark and Altars"] },
    5: { title: "Numbers Chapter 5", subtitle: "Purity & Restitution", description: "Laws for maintaining the purity of the camp and the test for unfaithful wives.", keyPoints: ["Expelling the unclean", "Confession and restitution", "The bitter water ritual"] },
    6: { title: "Numbers Chapter 6", subtitle: "The Nazirite Vow", description: "The laws for those taking a special vow of separation to the Lord and the Priestly Blessing.", keyPoints: ["Nazirite requirements", "Hair and grapevine products", "The Aaronic Blessing"] },
    7: { title: "Numbers Chapter 7", subtitle: "Tabernacle Offerings", description: "The unique and identical offerings brought by the twelve tribal leaders for the altar's dedication.", keyPoints: ["12 days of offerings", "Nahshon of Judah first", "Moses in the Most Holy Place"] },
    8: { title: "Numbers Chapter 8", subtitle: "Levite Consecration", description: "The setting up of the lamps and the purification of the Levites for their sacred work.", keyPoints: ["The seven lamps", "Shaving and washing", "Retirement age at 50"] },
    9: { title: "Numbers Chapter 9", subtitle: "Cloud & Fire", description: "The second Passover and God's guidance through the pillar of cloud and fire.", keyPoints: ["Supplementary Passover", "Following the Cloud", "God's timing for camp"] },
    10: { title: "Numbers Chapter 10", subtitle: "Silver Trumpets", description: "The making of the two silver trumpets and the departure from the Desert of Sinai.", keyPoints: ["Signals for the camp", "Order of marching", "Moses' request to Hobab"] },
    11: { title: "Numbers Chapter 11", subtitle: "Fire & Quail", description: "The complaints of the people, the appointment of 70 elders, and the massive provision of quail.", keyPoints: ["Taberah fire", "Craving for Egyptian food", "Spirit on the elders"] },
    12: { title: "Numbers Chapter 12", subtitle: "Miriam's Leprosy", description: "Miriam and Aaron speak against Moses, leading to Miriam's temporary leprosy and isolation.", keyPoints: ["Opposition to Moses", "God's defense of His servant", "Miriam's seven-day shame"] },
    13: { title: "Numbers Chapter 13", subtitle: "Twelve Spies", description: "Spies are sent to explore Canaan and return with reports of a rich land and fearsome giants.", keyPoints: ["Grapes of Eshcol", "Report of the 10 vs 2", "Caleb's faithful plea"] },
    14: { title: "Numbers Chapter 14", subtitle: "The Rebellion", description: "The people refuse to enter the land, leading to God's judgment of 40 years of wandering.", keyPoints: ["The night of weeping", "Moses' intercession", "Judgment of the generation"] },
    15: { title: "Numbers Chapter 15", subtitle: "Offerings & Tassels", description: "Laws on sacrifices, unintentional sins, and the command to wear tassels for remembrance.", keyPoints: ["Grain and drink offerings", "High-handed sins", "Tassels on garments"] },
    16: { title: "Numbers Chapter 16", subtitle: "Korah's Rebellion", description: "Korah leads a massive rebellion against Moses and Aaron, resulting in a dramatic divine judgment.", keyPoints: ["The earth opens up", "Censers and incense", "Plague stopped by Aaron"] },
    17: { title: "Numbers Chapter 17", subtitle: "Aaron's Staff", description: "God settles the dispute over the priesthood by making Aaron's staff bud, blossom, and bear almonds.", keyPoints: ["Twelve staffs named", "The staff that budded", "Warning to rebels"] },
    18: { title: "Numbers Chapter 18", subtitle: "Priests' Portions", description: "The roles of priests and Levites are defined along with the offerings they are to receive.", keyPoints: ["Guardian of the Sanctuary", "The tithe of the tithe", "Incorruptible covenant of salt"] },
    19: { title: "Numbers Chapter 19", subtitle: "Red Heifer", description: "The ritual of the red heifer and the preparation of the water of cleansing for purification.", keyPoints: ["Ashes for purification", "Uncleanness from the dead", "Application of the water"] },
    20: { title: "Numbers Chapter 20", subtitle: "Meribah", description: "Moses strikes the rock, Miriam and Aaron die, and Edom refuses passage to Israel.", keyPoints: ["No water at Kadesh", "Moses' disobedience", "Aaron's death on Mt. Hor"] },
    21: { title: "Numbers Chapter 21", subtitle: "Bronze Serpent", description: "The people complain and are bitten by snakes, leading to the provision of the bronze serpent for healing.", keyPoints: ["Snake on a pole", "Defeat of Sihon and Og", "The Song of the Well"] },
    22: { title: "Numbers Chapter 22", subtitle: "Balaam's Donkey", description: "King Balak hires Balaam to curse Israel, but God intervenes through a talking donkey.", keyPoints: ["Prophet for hire", "Angel on the road", "God controls the mouth"] },
    23: { title: "Numbers Chapter 23", subtitle: "Balaam's Oracles I & II", description: "Balaam attempts to curse Israel but delivers oracles of blessing instead, much to Balak's frustration.", keyPoints: ["Seven altars at Bamoth", "Blessing the people", "Oracles of God's favor"] },
    24: { title: "Numbers Chapter 24", subtitle: "Balaam's Oracles III & IV", description: "Balaam prophesies the future glory of Israel and the coming 'Star out of Jacob.'", keyPoints: ["Spirit of God on Balaam", "Star and Scepter prophecy", "Final oracles of doom"] },
    25: { title: "Numbers Chapter 25", subtitle: "Sin at Peor", description: "Israel falls into idolatry with Moabite women, and Phinehas' zeal stops a divine plague.", keyPoints: ["Baal of Peor", "Phinehas' spear", "Midianites identified as enemies"] },
    26: { title: "Numbers Chapter 26", subtitle: "Second Census", description: "A new census is taken of the second generation in the plains of Moab before entering Canaan.", keyPoints: ["601,730 fighting men", "Preparation for land division", "None left from the first census"] },
    27: { title: "Numbers Chapter 27", subtitle: "Joshua Appointed", description: "Zelophehad's daughters request inheritance, and Joshua is commissioned as Moses' successor.", keyPoints: ["Inheritance for daughters", "Moses on Mt. Abarim", "The spirit in Joshua"] },
    28: { title: "Numbers Chapter 28", subtitle: "Daily & Festival Sacrifices", description: "Detailed regulations for daily, Sabbath, monthly, and annual festival offerings.", keyPoints: ["Morning and evening lambs", "Monthly new moons", "Passover and Weeks"] },
    29: { title: "Numbers Chapter 29", subtitle: "Autumn Feasts", description: "Sacrificial requirements for the Feast of Trumpets, Day of Atonement, and Tabernacles.", keyPoints: ["The 70 bulls of Sukkot", "Day of self-denial", "Solemn assemblies"] },
    30: { title: "Numbers Chapter 30", subtitle: "Laws of Vows", description: "Regulations concerning the binding nature of vows and the rights of fathers and husbands to annul them.", keyPoints: ["Keeping one's word", "Vows of daughters and wives", "Confirmation and nullification"] },
    31: { title: "Numbers Chapter 31", subtitle: "War on Midian", description: "Israel defeats the Midianites, Balaam is killed, and the spoil is divided and purified.", keyPoints: ["Vengeance for Peor", "Cleansing the spoil", "Death of Balaam"] },
    32: { title: "Numbers Chapter 32", subtitle: "East of Jordan", description: "The tribes of Reuben, Gad, and half of Manasseh request to settle in the land east of the Jordan.", keyPoints: ["Livestock needs", "Moses' warning of rebellion", "The promise to fight first"] },
    33: { title: "Numbers Chapter 33", subtitle: "The Journey Log", description: "A summary of the 40-year journey from Egypt to the plains of Moab and instructions for Canaan.", keyPoints: ["Ramses to Jordan", "Driving out the inhabitants", "Dividing by lot"] },
    34: { title: "Numbers Chapter 34", subtitle: "Canaan Boundaries", description: "God defines the precise boundaries of the Promised Land and appoints leaders for division.", keyPoints: ["South, West, North, East", "Ten tribal leaders named", "Portion of the 9.5 tribes"] },
    35: { title: "Numbers Chapter 35", subtitle: "Cities of Refuge", description: "Levitical cities and cities of refuge are established for the protection of accidental killers.", keyPoints: ["48 Levite towns", "Six Cities of Refuge", "Manslayer vs Murderer"] },
    36: { title: "Numbers Chapter 36", subtitle: "Marriage of Heirs", description: "Rules ensuring that inheritance remains within the original tribe for female landholders.", keyPoints: ["Zelophehad's daughters marry", "Preserving tribal land", "Conclusion of the commands"] }
  },
  nehemiah: {
    1: {
