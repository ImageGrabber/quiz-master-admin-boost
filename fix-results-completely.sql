-- Complete fix for results system
-- This will recreate everything properly

-- 1. Drop existing results table and function if they exist
DROP TABLE IF EXISTS live_quiz_results CASCADE;
DROP FUNCTION IF EXISTS calculate_quiz_results(UUID);

-- 2. Create the results table with correct structure
...
-- 4. Create the calculate function
...
-- 5. Test the setup
SELECT 'Results system recreated successfully!' as result;
