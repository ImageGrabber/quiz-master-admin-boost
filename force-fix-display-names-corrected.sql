-- CORRECTED FORCE FIX for display names
-- This uses the actual column names that exist in the database
...
-- 2. Check what's in the profiles table (using actual columns)
...
-- Update from profiles table using actual columns
UPDATE online_users 
...
SELECT 'CORRECTED FORCE FIX COMPLETE - All names should be REAL now!' as result;
